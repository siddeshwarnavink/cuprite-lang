...
TEST(LexerTest, TestCondition) {
    {
        token_list list;
        token_list_create(&list);

        parse_line(&list, "whn a is 10 do\n say \"ten\"\nend");

        token_list_pp(list);

        EXPECT_EQ(list->size, 10);

        check_token_list(&list, 1, token_when);
        check_token_list(&list, 2, token_identf, "a");
        check_token_list(&list, 3, token_is);
        check_token_list(&list, 4, token_num_int, "10");
        check_token_list(&list, 5, token_do);
        check_token_list(&list, 6, token_eos);
        check_token_list(&list, 7, token_identf, "say");
        check_token_list(&list, 8, token_str, "ten");
        check_token_list(&list, 9, token_eos);
        check_token_list(&list, 10, token_end);
...

    {
        ...
        check_token_list(&list, 1, token_identf, "a");
        check_token_list(&list, 2, token_greater);
        check_token_list(&list, 3, token_num_int, "10");
        check_token_list(&list, 4, token_and);
        check_token_list(&list, 5, token_identf, "b");
        check_token_list(&list, 6, token_less_eq);
